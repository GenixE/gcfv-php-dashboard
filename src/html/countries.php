                    ...
                    <div class="card-body">
                        <table id="datatablesSimple" class="display">
                            ...
                            <tr>
                                ...
                                <th>Region</th>
                                <th>Actions
                                    <a href='../crud/country_new.php' class='mr-2' title='New File'
                                       data-toggle='tooltip'>
                            ...
                            foreach ($countries as $country): ?>
                                <tr>
                                    ...
                                    <td><?php echo $country->getRegionName(); ?></td>
                                    <td>
                                        <a href='../crud/country_view.php?id=<?php echo $country->country_id; ?>'
                                           class='mr-2' title='View File' data-toggle='tooltip'>
                                            <span class='fa fa-circle-info' style='margin-right: 10px;'></span>
                                        </a>
                                        <a href='../crud/country_update.php?id=<?php echo $country->country_id; ?>'
                                           class='mr-2' title='Update File' data-toggle='tooltip'>
                                            <span class='fa fa-pen-to-square' style='margin-right: 10px;'></span>
                                        </a>
                                        <a href='../crud/country_delete.php?id=<?php echo $country->country_id; ?>'
