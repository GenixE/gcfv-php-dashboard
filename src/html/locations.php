                    ...
                    <div class="card-body">
                        <table id="datatablesSimple" class="display">
                            ...
                            <tr>
                                ...
                                <th>Country</th>
                                <th>Actions
                                    <a href='../crud/location_new.php' class='mr-2' title='New File'
                                       data-toggle='tooltip'>
                            ...
                            foreach ($locations as $location): ?>
                                <tr>
                                    ...
                                    <td><?php echo $location->getCountryName(); ?></td>
                                    <td>
                                        <a href='../crud/location_view.php?id=<?php echo $location->location_id; ?>'
                                           class='mr-2' title='View File' data-toggle='tooltip'>
                                            <span class='fa fa-circle-info' style='margin-right: 10px;'></span>
                                        </a>
                                        <a href='../crud/location_update.php?id=<?php echo $location->location_id; ?>'
                                           class='mr-2' title='Update File' data-toggle='tooltip'>
                                            <span class='fa fa-pen-to-square' style='margin-right: 10px;'></span>
                                        </a>
                                        <a href='../crud/location_delete.php?id=<?php echo $location->location_id; ?>'
