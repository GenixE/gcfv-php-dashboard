                    ...
                    <div class="card-body">
                        <table id="datatablesSimple" class="display">
                            ...
                            <tr>
                                ...
                                <th>Actions
                                    <a href='../crud/category_new.php' class='mr-2' title='New File'
                                       data-toggle='tooltip'>
                            ...
                            foreach ($categories as $category): ?>
                                <tr>
                                    ...
                                    <td><?php echo $category->category_name; ?></td>
                                    <td><?php echo $category->parent_category_id; ?></td>
                                    <td>
                                        <a href='../crud/category_view.php?id=<?php echo $category->category_id; ?>'
                                           class='mr-2' title='View File' data-toggle='tooltip'>
                                            <span class='fa fa-circle-info' style='margin-right: 10px;'></span>
                                        </a>
                                        <a href='../crud/category_update.php?id=<?php echo $category->category_id; ?>'
                                           class='mr-2' title='Update File' data-toggle='tooltip'>
                                            <span class='fa fa-pen-to-square' style='margin-right: 10px;'></span>
                                        </a>
                                        <a href='../crud/category_delete.php?id=<?php echo $category->category_id; ?>'
